...
window.wm_title("Bookstore V1.0.0")
...
b1=Button(window,text="Update Entry", width=12, command=update_command)
b1.grid(row=5,column=3)

b1=Button(window,text="Delete Entry", width=12, command=delete_command)
